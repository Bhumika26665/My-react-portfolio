      ...
      <div className="section-view2 bg-gradient-custom py-10 h-lvh">
        <div className="container mx-auto flex flex-col-reverse md:flex-row">
          ...
          <div className="bg-white shadow-md p-6 md:w-1/2">
            ...
            <p className="mt-4">I design and develop services for customers of all sizes, modern websites, web services, and online stores.</p>
            <p className="mt-2">Looking for an entry-level position where I can utilize all my skills to benefit the company’s profit.</p>
            <div>
              <a href="#contact">
